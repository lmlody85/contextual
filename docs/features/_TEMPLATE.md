...
Brief description of what this feature does. Keep it to 2-3 sentences.
...
### Resolved Issues
- **Issue 2**: Description → Resolution and how it was fixed

*If no issues, write "None currently"*
...
*If feature is complete, write "Feature complete"*
